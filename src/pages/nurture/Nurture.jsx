...
const sequences = [
  { id: 1, name: "Implants — default", meta: "5 steps · SMS, Email, WhatsApp", status: "On", active: true },
  { id: 2, name: "Invisalign — default", meta: "4 steps · SMS, Email", status: "On" },
  { id: 3, name: "Re-engagement 14-day", meta: "3 steps · SMS, Email", status: "On" },
  { id: 4, name: "Appointment reminders", meta: "48h · 24h · 2h", status: "On" },
];

const channelStyle = {
  sms: { bg: "bg-slate-700", icon: <FiMessageSquare size={13} className="text-white" /> },
  email: { bg: "bg-teal-600", icon: <FiMail size={13} className="text-white" /> },
  whatsapp: { bg: "bg-emerald-500", icon: <FaWhatsapp size={14} className="text-white" /> },
};
  ...
  return (
    <button
      ...
      className={`w-full text-left flex items-center justify-between px-6 py-4 border-l-2 transition-colors ${
        active ? "border-gray-900 bg-gray-50/70" : "border-transparent hover:bg-gray-50/50"
      }`}
    >
      <div>
      ...
      <div className="flex-1 pb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-3 text-gray-400">
            ...
            <FiTrash2 size={13} className="text-red-400 hover:text-red-600 cursor-pointer" />
          </div>
        </div>
        ...
        {!isLast && (
          <div className="flex items-center gap-1.5 mt-4 text-gray-400">
            ...
            <span className="font-mono text-[10px] uppercase tracking-wider">{step.wait}</span>
          </div>
        )}
      </div>
    </div>
        ...
        <div className="lg:flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 max-w-2xl leading-relaxed">
              Automated follow-up that keeps leads warm until they book. SMS
              and email on every plan, WhatsApp on Growth and Full.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          ...
          <div className="bg-white rounded-2xl border border-black/5 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-50">
              <h2 className="font-serif text-xl text-gray-900">Your sequences</h2>
            </div>
            <div>
              {sequences.map((seq) => (
                <SequenceRow
          ...
          <div className="bg-white rounded-2xl border border-black/5 p-6">
            <div className="flex items-start justify-between mb-6">
              <div>
                <h2 className="font-serif text-xl text-gray-900">Implants — default</h2>
